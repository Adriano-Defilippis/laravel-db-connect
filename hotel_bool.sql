...
--
-- Host: localhost
-- Creato il: Ott 01, 2019 alle 00:56
...
--
-- Struttura della tabella `paganti`
--
...
--
-- Dump dei dati per la tabella `paganti`
--
...
--
-- Struttura della tabella `prenotazioni_has_ospiti`
--
...
--
-- Dump dei dati per la tabella `prenotazioni_has_ospiti`
--
...
--
-- Indici per le tabelle `prenotazioni_has_ospiti`
--
...
--
-- AUTO_INCREMENT per la tabella `paganti`
--
ALTER TABLE `paganti`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
-- AUTO_INCREMENT per la tabella `prenotazioni_has_ospiti`
--
ALTER TABLE `prenotazioni_has_ospiti`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
-- Limiti per la tabella `prenotazioni_has_ospiti`
--
ALTER TABLE `prenotazioni_has_ospiti`
